...
```bash
uv add 'time-toolkit @ git+https://github.com/erstcl/time-toolkit.git@v0.4.0'
```
...
```bash
uv add 'time-toolkit[mcp,realtime,service] @ git+https://github.com/erstcl/time-toolkit.git@v0.4.0'
```
